codeunit 76000 "CB Vérification"
{
    ...
    procedure EncodeCode128(pcodBarcode: Code[1024]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Company Information" temporary)
    var
    ...
    begin
        ...
        precTmpTempBlob.Picture.CreateOutStream(loutBmpHeader);
    ...
    procedure EncodeCode39(pcodBarcode: Code[1024]; pintSize: Integer; pblnCheckDigit: Boolean; pblnVertical: Boolean; var precTmpTempBlob: Record Item)
    var
        lrecTmpCode39: Record "CB Code 12839" temporary;
        lintCount1: Integer;
        lintSum: Integer;
        lintConvInt: Integer;
        lintCheckDigit: Integer;
    ...
    procedure EncodeEAN8(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record Item)
    var
        ltxtWeight: Text[12];
        ltxtSentinel: Text[3];
        ltxtCenterGuard: Text[6];
    ...
    begin
        ...
        charInf := 'M';
        poutBmpHeader.Write(charInf, 1);
        poutBmpHeader.Write(54 + pintRows * pintCols * 3, 4);
        poutBmpHeader.Write(0, 4);
        poutBmpHeader.Write(54, 4);
        poutBmpHeader.Write(40, 4);
        poutBmpHeader.Write(lintWidth, 4);
        poutBmpHeader.Write(lintHeight, 4);
        poutBmpHeader.Write(65536 * 24 + 1, 4);
        poutBmpHeader.Write(0, 4);
        poutBmpHeader.Write(0, 4);
        poutBmpHeader.Write(lintResolution, 4);
        poutBmpHeader.Write(lintResolution, 4);
        poutBmpHeader.Write(0, 4);
        poutBmpHeader.Write(0, 4);
    end;
    ...
    local procedure InitCode128(var precTmpCode128: Record "CB Code 12839" temporary)
    begin
        precTmpCode128.Init;
    ...
    local procedure InitCode39(var precTmpCode39: Record "CB Code 12839" temporary)
    begin
